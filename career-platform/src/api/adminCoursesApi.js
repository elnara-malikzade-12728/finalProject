...
export const updateCategory = (id, body) => apiRequest(`/courses/categories/${id}`, { method: 'PATCH', body });
...
export const updateModule = (id, body) => apiRequest(`/courses/modules/${id}`, { method: 'PATCH', body });
