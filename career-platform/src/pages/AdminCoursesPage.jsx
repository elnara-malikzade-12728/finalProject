            ...
            <details className="course-tree-course" key={course.id} open>
              <summary>
                ...
                <span className="course-tree-actions">
                  ...
                  <span className="course-item-icon-actions">
                    ...
                    <button type="button" className="danger" title="Kursu sil" aria-label="Kursu sil" onClick={(event) => { event.preventDefault(); confirmDelete(`“${course.title}” kursu və bütün dərsləri silinsin?`, () => deleteCourse(course.id), 'Kurs silindi.'); }}><Trash2 size={16} /></button>
                  </span>
                </span>
              </summary>
